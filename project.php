...
<table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
    <td valign="top" align="left" background="img/i.jpeg" style="background-repeat:no-repeat; background-size:cover;height:650px;"> 
	<div class="container">
	...
	<a href="addp.php"><input  style="font-weight:bold" type="button" name="adde" value="ADD PROJECT" id="bto"/></a>
	<center>
	<h1 style="color:black;"><b>PROJECT DETAILS</b></h1>
	</center>
	<table class="table table-responsive" border="2" style="border-color:black; background-color:white">
		...
		while($row=$res->fetch_assoc())
		{
			...
			<td><form method="POST" action="project.php"><input type="submit" value="'.$pno.'" class="btn btn-danger btn-xs" name="pan"/></form></td>
			</tr>';$i++;
		}
?>
	</div>
